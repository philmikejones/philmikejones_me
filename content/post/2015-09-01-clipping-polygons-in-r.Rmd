...
First, install and load `sf` for loading the shapefiles, the `dplyr` for manipulating the data, and `ggplot2` for plotting the maps.
...
```{r insert-yh_lads-plot, echo=FALSE}
blogdown::shortcode_html(
  "figure",
  src = "../../img/yh_lads.png",
