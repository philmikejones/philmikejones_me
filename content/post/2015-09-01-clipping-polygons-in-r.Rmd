...
```{r package-load, include=TRUE, echo=TRUE, eval=FALSE}
...
Then download and open our test data (shapefiles of English regions and local authorities):
...
```{r load-shapefiles, include=TRUE, echo=TRUE, eval=FALSE}
reg <- read_sf(  # regions
  dsn = tmp_dir,
...
```{r create-regions-plot, include=TRUE, echo=TRUE, eval=FALSE}
ggplot(reg) + geom_sf()
```
...
```{r insert-regions-plot, include=FALSE, echo=FALSE, eval=TRUE}
...
```{r create-lads-plot, include=TRUE, echo=TRUE, eval=FALSE}
ggplot(lad) + geom_sf()
```
...
```{r insert-lads-plot, include=FALSE, echo=FALSE, eval=TRUE}
blogdown::shortcode_html(
  "figure",
  src = "../../img/lads.png",
...
```{r filter-yh-lads, include=TRUE, echo=TRUE, eval=FALSE}
yh <- 
  reg %>% 
...
```{r create-yh_lads-plot, include=TRUE, echo=TRUE, eval=FALSE}
...
```{r insert-yh_lads-plot, include=FALSE, echo=FALSE, eval=TRUE}
blogdown::shortcode_html(
  "figure",
  src = "../../img/yh_lads.png",
...
```{r str-yh-lads, include=TRUE, echo=TRUE, eval=TRUE}
yh_lads
```
