...
- They don't use the [S4 object system](http://adv-r.had.co.nz/S4.html), which means no more `@` slots.
...
- `sf` functions no longer drop the data frame, which many of the `rgdal` functions did.
