...
So far, so good.
I also want to test to see if the maximum number of units is sensible.
I don't know in advance what the maximum number of drinks is, but we can work that out:
